        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
			...
			<div class="col-md-8 col-sm-8  ">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Profilim <br><small>Profil verileri anlık olarak veritabanından çekilmektedir. </small></h2>
                    <div class="clearfix"></div>
                  </div>
					<div class="x_content">
						<br />
						<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
							...
							<div class="item form-group">
								<label class="col-form-label col-md-3 col-sm-3 label-align">Meslek</label>
								<div class="col-md-6 col-sm-6 ">									
